...
*Note: this needs to be revisited. The 193.2 explanation requires special pleading, and on further inspection, so does the 151.1 match. The commentary for KP suggests this refers to dung and urine falling as the oxen are ploughing the field rather than as a intentional manuring step. KP discusses sara vimochanam in detail separately, so we are not ruling out the connection, just questioning the fitness of this particular match. Also it is not a parsimonious single verse or sequential verse-pair match.*
